<template>
  <div class="shop_container">
        <ul class="shop_list" v-if="shopList.length">
          <li v-for="item in shopList" :key="item.id" class="shop_li border-1px" @click="$router.push('/shop')">
            <a>
              <div class="shop_left">
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  ...
                  <ul class="shop_detail_ul">
                    <li class="supports" v-for="(support,index) in item.supports" :key="index" :style="{color:support.icon_color}">{{support.icon_name}}</li>
                  </ul>
                </section>
