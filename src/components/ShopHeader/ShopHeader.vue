    ...
    <div class="shop-content"
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">距离你{{shop.distance}}</span>
          <span class="shop-message-detail">
            <span>约 {{shop.order_lead_time}}</span>
          </span>
        </div>
      </div>
    </div>
      ...
      <div class="shop-brief-modal"
        ...
        <div class="brief-modal-content">
          ...
          <ul class="brief-modal-msg">
            ...
            <li>
              <h3>月售</h3>
              <p>{{shop.recent_order_num}}单</p>
            </li>
            <li>
              <h3>极速送</h3>
              <p>约{{shop.order_lead_time}}</p>
            </li>
            <li>
              <h3>配送费</h3>
              <p>{{shop.float_delivery_fee}}元</p>
            </li>
            <li>
              <h3>距离</h3>
              <p>{{shop.distance}}</p>
...
export default {
  ...
  mounted () {
    this.$store.dispatch('shopAbout/req_shop_info')
  }
}
</script>
